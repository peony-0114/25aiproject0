...
mbti_recommendations = {
    ...
    "INTJ": {
        ...
        "official_description": "📝 **INTJ**는 독립적이고 전략적인 성향을 가지며, 문제를 해결하는 데 뛰어난 능력을 가지고 있습니다. 항상 효율적이고 실용적인 방법을 찾고자 합니다.",
        "hobby_match": "🧩 **추천 취미 활동:** 체스, 전략 게임, 독서\n**같이 즐기면 좋은 MBTI:** ENTP, INTP"
    },
